...
const QString BITCOIN_IPC_PREFIX("Tdcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Tdcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Tdcoin: click-to-pay handler");
    else
...
{
    // clicking on Tdcoin: URLs creates FileOpen events on the Mac:
