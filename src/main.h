...
static const int64_t MAX_MONEY = 5565000000 * COIN;
...
public:
    ...
    {
        // Tdcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Tdcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Tdcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Tdcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Tdcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Tdcoin: block index flags
    enum  
    {
